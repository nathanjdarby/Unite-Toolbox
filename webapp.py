...
@app.route('/launch_other_app')
def launch_other_app_route():
    launch_other_app()
...
@app.route('/workplacedivide', methods=['POST'])
def workplacedivide_route():
    workplacedivide()
    return redirect(url_for('home'))

@app.route('/SMS_only', methods=['POST'])
def SMS_only_route():
    SMS_only()
    return redirect(url_for('home'))

@app.route('/handle_html_file', methods=['POST'])
def handle_html_file_route():
    handle_html_file()
    return redirect(url_for('home'))
